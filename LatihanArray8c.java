 ...
 */
package latihanarray8c;
import java.util.Arrays;
/**
 *
 * @author Inue
 */
public class LatihanArray8c {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(byteKey + " found at index = " + Arrays.binarySearch(byteArr, byteKey)); //Arrays.binarySearch untuk mencari data
